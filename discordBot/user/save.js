...
function restore() {
	...
	lisId.forEach(element => {
		...
		const Nuser = new user(tempUser.id, tempUser.tag, tempUser.cash, tempUser.walet, tempUser.history, tempUser.watinMp, tempUser.sellStop, tempUser.limitSell, true);
